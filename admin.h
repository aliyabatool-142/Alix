...
public:
    Admin(int userID, string userName, string password)
        : User(userID, userName, password, "Admin")
    {
    }
    ...
    void updateMurderStatus()
    {
        ...
        while (getline(fin, line))
        {
            ...
            size_t sep2 = line.find('|', sep1 + 1);  //sep1+1 means we start searching from 3rd index, sep2 = 9
            string currentStatus = line.substr(sep1 + 1, sep2 - sep1 - 1);  //3, 9-2-1(=6)
            currentStatus.erase(0, currentStatus.find_first_not_of(" ")); // trim spaces from left
    ...
    void deleteCaseByID(string filename)
    {
        int id;
        ...
        while (getline(fin, line))
        {
            ...
            int fileID = stoi(line.substr(0, sep));
   ...
   void viewAllCrime() {
    int choice;
    cout << "1️⃣  to view murder cases  🔪🔪🔪\n2️⃣  to view theft cases  🧱🪜 🪚\n3️⃣  to view cybercrime cases 🎭🎭🎭  : \n";
    cout<<"💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠\n";
    ...
    { 
        ...
        cout << "1️⃣  Add Crime\n";
        cout << "2️⃣  Update Crime\n";
        cout << "3️⃣  Delete Crime\n";
        cout << "4️⃣  View all Crime\n";
        cout << "5️⃣  Logout\n";
        cout << "💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠💠" << endl;
        ...
        case 1:
            ...
            {
                cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
                cout << "     🔪  ADDING CRIME RECORD (MURDER)     \n";
                cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
            ...
            {
                 cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
                cout << "     🛍️  ADDING CRIME RECORD (THEFT)     \n";
                cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
            ...
            {
                 cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
                cout << "     💻  ADDING CRIME RECORD (CYBER-CRIME)     \n";
                cout << "◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆\n";
        ...
        case 3:
            cout << "╔══════════════════════════════════════════════╗\n";
            cout << "║        ❌  DELETE CRIME RECORD               ║\n";
            cout << "╚══════════════════════════════════════════════╝\n";

            cout << "1. Delete Murder Case\n";
            cout << "2. Delete Theft Case\n";
            cout << "3. Delete Cybercrime Case\n";
            int ch;
            cout << "Please enter your choice: ✒️  ";
            cin >> ch;

            if (ch == 1)
                deleteCaseByID("murder.txt");
            else if (ch == 2)
                deleteCaseByID("theft.txt");
            else if (ch == 3)
                deleteCaseByID("cybercrime.txt");
            else
                cout << "invalid choie......\n";
